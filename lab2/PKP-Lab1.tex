...
\section{Kūrimo procesas}
	...
	\begin{enumerate}
		\item{
			...
			Taip pat išsiaikšinami baziniai reikalavimai, kurie yra patys svarbiausi yra turi būti pirmi igyvendinti, baziniai reikalavimai yra atitinkamai pažymimi.
			Kompanija pateikia prieeigą prie sistemos, su visu reikalavimų sąrašu, kur užsakovai gali stebėti jų įvykdymą.
			Testuojant suprogramuotą funkcionalumą ir įgyvendinus reikalavimą sistemoje tada ateityje pažymima jog reikalavimas įgyvendintas.
