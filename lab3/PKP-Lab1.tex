	...
	\begin{center}
		\begin{table}[ht]
			...
			\begin{tabular}{ | l | l | }
				...
				Sukuriami produktai:	& \textcolor{pink}{SP1 - Technologinių sprendimų ir jų alternatyvų dokumentas su} \\& \textcolor{pink}{preliminariomis technologijų licenzijų kainomis.}	\\ \hline
			\end{tabular}
		\end{table}
	\end{center}
	\newpage
...
Atlikus testavimus, jei vartotojo dokumentacija dar neparašyta vartotojo dokumentacija, ji parašoma implementuotom užduotim, o jei jos nėra, ji atnaujinama.
		...
		\begin{table}[ht]
			...
			\begin{tabular}{ | l | l | }
				...
				Veiklos:		& V1 - Aptariamas kiekvienas modelio procesas. 				\\
							...
							& \textcolor{pink}{V3 - Surašomi gerinimo pasiūlymai.}				\\ 
				...
				Sukuriami produktai:	& \textcolor{pink}{SP1 - Pagerintas programų kūrimo proceso modelis.}		\\ \hline
			\end{tabular}
		\end{table}
	\end{center}
	...
	\begin{enumerate}
		...
		\item{\textcolor{pink}{Apžvelgiamos metrikos ir kaip jos atsispindi tame, kas buvo kalbama pirmoje veikloje. 
		...
		\item{\textcolor{pink}{Kiekvienas susirinkimo dalyvis anonimiškai surašo savo pasiūlymus kaip gerinti procesą.}
