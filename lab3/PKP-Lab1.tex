...
\section{Kūrimo procesas}
	...
	\begin{center}
		\begin{table}[ht]
			...
			\begin{tabular}{ | l | l | }
				\hline
				Pavadinimas:          & \textcolor{green}{Projekto siūlymas.}						\\ \hline
	...
	\begin{center}
		\begin{table}[ht]
			...
			\begin{tabular}{ | l | l | }
				\hline
				Pavadinimas:          & \textcolor{green}{Technologinio sprendimo paieška ir įgyvendinimas.}									\\ \hline
	...
	\begin{enumerate}
		\item{
			\textcolor{green}{Aptariamos technologijos, kurios šiuo metu naudojamos projekte - išskiriami technologiniai karkasai, duomenų bazės, programavimo kalbų versijos ir kitos naudojamos technologijos ir jų versijos.
		...
		\item{\textcolor{green}{Nustatomos technologijų kainos, kurios bus naudojamos projekte - paskaičiuojamos dabartinių technologijų kainos ir naujų siūlomų technologijų kainos.}}
		\item{
			\textcolor{green}{Nutariama dėl technologinių alternatyvų - jeigu įmanoma klientui pasiūlomi atviro kodo technologiniai sprendimai siekiant sutaupyti pinigų.
	...
	\begin{center}
		\begin{table}[ht]
			...
			\begin{tabular}{ | l | l | }
				\hline
				Pavadinimas:          & \textcolor{green}{Reikalavimų ciklas.}                                                                                                            \\ \hline
	...
	\begin{center}
		\begin{table}[ht]
			...
			\begin{tabular}{ | l | l | }
				\hline
				Pavadinimas:         & \textcolor{green}{Sistemos modeliavimas.}                                                \\ \hline
	...
	\begin{center}
		\begin{table}[ht]
			...
			\begin{tabular}{ | l | l | }
				\hline
				Pavadinimas:         & \textcolor{green}{Sprinto užduočių tikslinimas ir vertinimas.}				\\ \hline
	...
	\begin{center}
		\begin{table}[ht]
			...
			\begin{tabular}{ | l | l | }
				\hline
				Pavadinimas:         & \textcolor{green}{Užduočių analizė.}								\\ \hline
	...
	\begin{center}
		\begin{table}[ht]
			...
			\begin{tabular}{ | l | l | }
				\hline
				Pavadinimas:         & \textcolor{green}{Programavimas.}                                     \\ \hline
	...
	\begin{center}
		\begin{table}[ht]
			...
			\begin{tabular}{ | l | l | }
				\hline
				Pavadinimas:         & \textcolor{green}{Priėmimo testavimas.}                                               \\ \hline
	...
	\begin{center}
		\begin{table}[ht]
			...
			\begin{tabular}{ | l | l | }
				\hline
				Pavadinimas:          & \textcolor{green}{Kokybės užtikrinimas.}                                \\ \hline
...
Atlikus testavimus, jei vartotojo dokumentacija dar neparašyta vartotojo dokumentacija, ji parašoma implementuotom užduotim, o jei jos nėra, ji atnaujinama.
	...
	\textcolor{green}{Kiekvienas programuotojas yra atsakingas už kitų savo rato programuotojų kodo peržiūrą (angl. Pull Request review) prieš jo kėlimą į aukštesnes aplinkas.}
	...
	\begin{center}
		\begin{table}[ht]
			...
			\begin{tabular}{ | l | l | }
				\hline
				Pavadinimas:         & \textcolor{green}{Konfigūracijos valdymas.}				\\ \hline
	...
	\begin{center}
		\begin{table}[ht]
			...
			\begin{tabular}{ | l | l | }
				\hline
				Pavadinimas:         & \textcolor{green}{Sprinto aptarimas.}							\\ \hline
	...
	\begin{center}
		\begin{table}[ht]
			...
			\begin{tabular}{ | l | l | }
				\hline
				Pavadinimas:         & \textcolor{green}{Defekto analizė.}				\\ \hline
	...
	\begin{center}
		\begin{table}[ht]
			...
			\begin{tabular}{ | l | l | }
				\hline
				Pavadinimas:         & \textcolor{green}{Išleidimas.}						\\ \hline
	...
	\begin{center}
		\begin{table}[ht]
			...
			\begin{tabular}{ | l | l | }
				\hline
				Pavadinimas:         & \textcolor{green}{Palaikymas.}								\\ \hline
	...
	\begin{center}
		\begin{table}[ht]
			...
			\begin{tabular}{ | l | l | }
				\hline
				Pavadinimas:         & \textcolor{green}{Proceso gerinimas.}						\\ \hline
	...
	\begin{enumerate}
		...
		\item{\textcolor{green}{Kiekvienas susirinkimo dalyvis anonimiškai surašo savo pasiūlymus kaip gerinti procesą.}
